...
// TODO
// show movement over a week for supply and buyout price separately
  // criteria for judging market liquidity
  // criteria for judging buy/sell points
// deploy on heroku
// set heroku job scheduler (every two hours)
